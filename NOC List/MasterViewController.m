...
- (void)viewDidLoad
{
    ...
    //self.agents = [NSMutableArray new]
...
- (void)loadNocList {
    ...
    for(NSDictionary* dictionary in agents) {
        
        Agent *anAgent =  [Agent agentWithDictionary: dictionary];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    //
    if ([[segue identifier] isEqualToString:@"Agent"])
    {
        //
        ...
        detailview.agent = selectedAgent;
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Agents" forIndexPath:indexPath];
