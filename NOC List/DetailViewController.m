...
- (void)configureView
{
    ...
    if (self.agent)
    {
        ...
        self.realNameLabel.text = [NSString stringWithFormat:@" %@", self.agent.realName];
        self.coverNameLabel.text = [NSString stringWithFormat:@"%@", self.agent.coverName];
        self.accessLevelLabel.text = [NSString stringWithFormat:@"%i", (int)self.agent.accessLevel];
